...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djstripe_customer', 'subscriber_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['members.Member'], unique=True, null=True))

        # Changing field 'InvoiceItem.plan'
        db.alter_column(u'djstripe_invoiceitem', 'plan', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Customer.subscriber'
        db.alter_column(u'djstripe_customer', 'subscriber_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

        # Changing field 'InvoiceItem.plan'
        db.alter_column(u'djstripe_invoiceitem', 'plan', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'djstripe.customer': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'stripe_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'subscriber': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['members.Member']", 'unique': 'True', 'null': 'True'})
        },
        u'djstripe.event': {
        ...
        u'djstripe.invoiceitem': {
            ...
            'period_end': ('django.db.models.fields.DateTimeField', [], {}),
            'period_start': ('django.db.models.fields.DateTimeField', [], {}),
            'plan': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'members.member': {
            ...
            'avatar': ('django.db.models.fields.files.ImageField', [], {'default': "u''", 'max_length': '200', 'blank': 'True'}),
            'country_code': ('django.db.models.fields.CharField', [], {'default': "u'US'", 'max_length': '2', 'blank': 'True'}),
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'user_set'", 'blank': 'True', 'to': u"orm['auth.Group']"}),
            'hotspot_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'newsletter_subscribe': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'referral_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'region_code': ('django.db.models.fields.CharField', [], {'default': "u'CA'", 'max_length': '10', 'blank': 'True'}),
            'roles': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['members.Role']", 'null': 'True', 'symmetrical': 'False'}),
            'user_permissions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'user_set'", 'blank': 'True', 'to': u"orm['auth.Permission']"}),
            'username': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'})
        },
        u'members.role': {
            'Meta': {'object_name': 'Role'},
            'display_label': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
